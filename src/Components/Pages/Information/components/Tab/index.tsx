...
export default function Tab(options: any) {
  const { data, label, title, subTitle, description, imgList } = options || {};

  const { activeTab, handleActiveTab, activeVideo, handleActiveVideo } =
    useTab();
      ...
      <div className="tab-body">
        <div className="txt">
          <h3>
            ...
            <span>{data[activeTab][subTitle]}</span>
          </h3>
        ...
        <div className="cont">
          <ul className="cont-list">
            <li
              className="tab-list-02"
              onClick={() => handleActiveVideo("img")}
            >
            ...
            <li
              className="tab-list-02"
              onClick={() => handleActiveVideo("video")}
            >
              <div className="ir icn02">
                <strong>동영상</strong>
                <span>
                  마치 그곳에 있는 것처럼 360도 전경을 한눈에 확인하세요!
                </span>
              </div>
            </li>
          </ul>
          <div className="wrap-items">
            {activeVideo === "img" ? (
              ...
              <video controls className="mySwiper" autoPlay>
                <source
                  src="https://www.sinmok-culture.co.kr/kr/videos/gx_room.mp4"
                  type="video/mp4"
                />
              </video>
            )}
